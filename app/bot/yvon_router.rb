class YvonRouter
  def initialize
    @message_controller = YvonBot::MessagesController.new
    @user_controller = YvonBot::UsersController.new
    @restaurant_controller = YvonBot::RestaurantsController.new
    @meal_controller = YvonBot::MealsController.new
    @order_controller = YvonBot::OrdersController.new
  end
